...
if __FILE__ == $0
  ...
  all_passed &= run_test("Multi-word sentence", "Howdy partner, sit down! How's it going?", dictionary, { "down" => 1, "go" => 1, "going" => 1, "how" => 2, "howdy" => 1, "it" => 2, "i" => 3, "own" => 1, "part" => 1, "partner" => 1, "sit" => 1 })
  ...
  all_passed &= run_test("Mixed types in dictionary", "hello 123", ["hello", 123, nil, "123"], { "hello" => 1, "123" => 1 })
